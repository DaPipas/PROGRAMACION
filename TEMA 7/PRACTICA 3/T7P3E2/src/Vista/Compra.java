...
public class Compra extends javax.swing.JDialog {
    ...
    public Compra(java.awt.Frame parent, boolean modal, int unidades){
        super(parent, modal);
        initComponents();
    ...
    private void tfPrecioCompraFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfPrecioCompraFocusLost
        ...
        if(!error)
        {
            t7p3e2.T7P3E2.llenarCbProveedores(cbProveedores);
    ...
    private void cbProveedoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbProveedoresActionPerformed
        ...
        double total = (Double.parseDouble(tfPrecioCompra.getText()) * unidades);
    ...
    private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
        t7p3e2.T7P3E2.actualizarCompraProducto(Double.parseDouble(tfPrecioCompra.getText()), unidades);
