    ...
    public void create(Empresa empresa) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Persona personaListPersona : empresa.getPersonaList()) {
                Empresa oldNifEmpresaOfPersonaListPersona = personaListPersona.getNifEmpresa();
                personaListPersona.setNifEmpresa(empresa);
                personaListPersona = em.merge(personaListPersona);
                if (oldNifEmpresaOfPersonaListPersona != null) {
                    oldNifEmpresaOfPersonaListPersona.getPersonaList().remove(personaListPersona);
                    oldNifEmpresaOfPersonaListPersona = em.merge(oldNifEmpresaOfPersonaListPersona);
                }
            }
        ...
        try {
            ...
            for (Persona personaListOldPersona : personaListOld) {
                if (!personaListNew.contains(personaListOldPersona)) {
                    ...
                    illegalOrphanMessages.add("You must retain Persona " + personaListOldPersona + " since its nifEmpresa field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Persona personaListNewPersona : personaListNew) {
                if (!personaListOld.contains(personaListNewPersona)) {
                    Empresa oldNifEmpresaOfPersonaListNewPersona = personaListNewPersona.getNifEmpresa();
                    personaListNewPersona.setNifEmpresa(empresa);
                    personaListNewPersona = em.merge(personaListNewPersona);
                    if (oldNifEmpresaOfPersonaListNewPersona != null && !oldNifEmpresaOfPersonaListNewPersona.equals(empresa)) {
                        oldNifEmpresaOfPersonaListNewPersona.getPersonaList().remove(personaListNewPersona);
                        oldNifEmpresaOfPersonaListNewPersona = em.merge(oldNifEmpresaOfPersonaListNewPersona);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(String id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (Persona personaListOrphanCheckPersona : personaListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Empresa (" + empresa + ") cannot be destroyed since the Persona " + personaListOrphanCheckPersona + " in its personaList field has a non-nullable nifEmpresa field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
